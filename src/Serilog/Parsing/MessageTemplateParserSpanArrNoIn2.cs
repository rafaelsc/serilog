...
namespace Serilog.Parsing
{
    ...
    /// tokens.
    /// </summary>
    public class MessageTemplateParserSpanArrNoIn2 : IMessageTemplateParser
    {
        ...
        public MessageTemplate Parse(string messageTemplate)
        {
            ...
            var tokens = messageTemplate.Length == 0 ? EmptyMessageTemplateTextToken : Tokenize(messageTemplate.AsSpan());
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static bool TryParseIntInternal(ReadOnlySpan<char> str, out int result)
        {
#if TRYPARSEWITHSPAN
